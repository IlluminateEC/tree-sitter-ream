LANGUAGE_NAME := tree-sitter-ream
HOMEPAGE_URL := https://github.com/tree-sitter/tree-sitter-ream
VERSION := 0.1.0
DESCRIPTION := Ream langauge
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/ream '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/ream
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/ream
